...
const Dashboard = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError('An error occurred while predicting defects. Please try again.')
    }
  }
  ...
  return (
    <>
      ...
      <CCard className="mb-4">
        <CCardHeader>Defect Prediction</CCardHeader>
        <CCardBody>
          <CRow>
            <CCol xs={12}>
                  ...
                  <CRow key={index} className="mb-3">
                    ...
                    <CCol xs={8} sm={10}>
                      <input
                        ...
                        onChange={handleChange} // Ensure handleChange is defined too
                        required
